...
class MatScholarProcessTest(unittest.TestCase):

    def setUp(self):

        self.msp = MatScholarProcess()
    ...
    def test_is_number(self):
        ...
        self.assertTrue(self.msp.is_number("-5"))
        self.assertTrue(self.msp.is_number("-5.5"))
        self.assertTrue(self.msp.is_number("123.4"))
        self.assertTrue(self.msp.is_number("1,000,000"))

        self.assertFalse(self.msp.is_number("not a number"))
        self.assertFalse(self.msp.is_number("with23numbers"))
        self.assertFalse(self.msp.is_number("23.54b"))
        self.assertFalse(self.msp.is_number("-23a"))

    def test_is_simple_formula(self):

        self.assertTrue(self.msp.is_simple_formula("CoO"))
        self.assertTrue(self.msp.is_simple_formula("H2O"))
        self.assertTrue(self.msp.is_simple_formula("C(OH)2"))
        self.assertTrue(self.msp.is_simple_formula("C(OH)2Si"))
        self.assertTrue(self.msp.is_simple_formula("Ni0.5(CO)2"))

        self.assertFalse(self.msp.is_simple_formula("Ad2Al"))
        self.assertFalse(self.msp.is_simple_formula("123"))
        self.assertFalse(self.msp.is_simple_formula("some other text"))
        self.assertFalse(self.msp.is_simple_formula("Ni0.5(CO)2)"))

    def test_get_ordered_integer_formula(self):

        self.assertEqual(self.msp.get_ordered_integer_formula({"Al": 1, "O": 1.5}), "Al2O3")
        self.assertEqual(self.msp.get_ordered_integer_formula({"C": 0.04, "Al": 0.02, "O": 0.5}), "AlC2O25")

    def test_normalized_formula(self):

        self.assertEqual(self.msp.normalized_formula("SiO2"), "O2Si")
        self.assertEqual(self.msp.normalized_formula("Ni(CO)4"), "C4NiO4")
        self.assertEqual(self.msp.normalized_formula("Ni(CO)4SiO2"), "C4NiO6Si")

    def test_remove_accent(self):

        self.assertEqual(self.msp.remove_accent("Louis Eugène Félix Néel"), "Louis Eugene Felix Neel")
        self.assertEqual(self.msp.remove_accent("ångström"), "angstrom")
        self.assertEqual(self.msp.remove_accent("Å"), "Å")

    def test_is_element(self):

        for elem in self.msp.ELEMENTS[:100]:
            self.assertTrue(self.msp.is_element(elem))

        self.assertFalse(self.msp.is_element("not an element"))
        self.assertFalse(self.msp.is_element("A"))
        self.assertFalse(self.msp.is_element("Dc"))
        self.assertFalse(self.msp.is_element("14"))
        self.assertFalse(self.msp.is_element("We"))
